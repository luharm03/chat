<?php
	...
	if(!runQry($findUser))
	{
		 echo $insertUser = "INSERT INTO `chat_users_rooms` (`id`, `username`, `room`, `mod_time`,`uesrname2`) VALUES ( NULL , '$chatprsn', '$room', '$now','$username'),( NULL , '$username', '$room', '$now','$chatprsn')";
